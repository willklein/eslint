...
var concat = require("concat-stream"),
    configAutoInit = require("../lib/config-autoinitializer"),
...
var exitCode = 0,
    ...
    autoInit = (process.argv.indexOf("--autoinit") > -1);

function initializeCallback(err) {
    if (err) {
        exitCode = 1;
...
if (useStdIn) {
    ...
    configInit.initializeConfig(initializeCallback);
} else if (autoInit) {
    configAutoInit.initializeConfig(initializeCallback);
} else {
